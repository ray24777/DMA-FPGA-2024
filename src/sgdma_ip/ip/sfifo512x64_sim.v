...
module sfifo512x64  // sfifo512x64.v(14)
  ...
  wire [13:0] fifo_inst_syn_17;  // sfifo512x64.v(38)
  wire [13:0] fifo_inst_syn_3;  // sfifo512x64.v(38)
  ...
  PH1_PHY_ERAM #(
    ...
    .dia(di[55:40]),
    .dia_extra(di[59:56]),
    .dib({open_n371,open_n372,open_n373,open_n374,open_n375,open_n376,open_n377,open_n378,open_n379,open_n380,open_n381,open_n382,di[63:60]}),
    .fifoctrl_raddr(fifo_inst_syn_17),
    .fifoctrl_re(fifo_inst_syn_32),
    .fifoctrl_waddr(fifo_inst_syn_3),
    .fifoctrl_we(fifo_inst_syn_31),
    ...
    .dob({open_n423,open_n424,open_n425,open_n426,open_n427,open_n428,open_n429,open_n430,open_n431,open_n432,open_n433,open_n434,dout[63:60]}));  // sfifo512x64.v(38)
