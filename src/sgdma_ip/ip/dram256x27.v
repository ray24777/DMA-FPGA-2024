 ...
 ** File	:	D:/my_project/O__Verimake__DEMO__PH1A90/sgdma_prj_90k/src/sgdma_ip/ip/dram256x27.v
 ** Date	:	2024 09 09
...
module dram256x27 ( di, waddr, we, wclk, rdo, raddr );

	parameter DATA_WIDTH_W = 27; 
	parameter ADDR_WIDTH_W = 8;
	parameter DATA_DEPTH_W = 256;
	parameter DATA_WIDTH_R = 27;
