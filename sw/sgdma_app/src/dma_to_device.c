...
#define DEVICE_NAME_DEFAULT "/dev/ANLOGIC-PCI0_h2c_0"
            ...
            char *ofname)
{
    ...
    for (i = 0; i < count; i++) {
        ...
        total_time += (ts_end.tv_sec * 1000 * 1000 * 1000ULL + ts_end.tv_nsec - (ts_start.tv_sec * 1000 * 1000 * 1000ULL + ts_start.tv_nsec));
